...
// state.Settings, as needed by the caasoperator API.
...
// expected to be strings anyway, we need to fix the caasoperator code
...
// caasoperator's control. So we may need to send diffs of what has changed
