...
// Kind enumerates the operations the caasoperator can perform.
type Kind string

const (
	// Install indicates that the caasoperator is installing the charm.
	Install Kind = "install"

	// RunHook indicates that the caasoperator is running a hook.
	RunHook Kind = "run-hook"

	// RunAction indicates that the caasoperator is running an action.
	RunAction Kind = "run-action"

	// Upgrade indicates that the caasoperator is upgrading the charm.
	Upgrade Kind = "upgrade"

	// Continue indicates that the caasoperator should run ModeContinue
...
const (
	// Queued indicates that the caasoperator should undertake the operation
	// as soon as possible.
	Queued Step = "queued"

	// Pending indicates that the caasoperator has started, but not completed,
	// the operation.
	Pending Step = "pending"

	// Done indicates that the caasoperator has completed the operation,
	// but may not yet have synchronized all necessary secondary state.
	Done Step = "done"
)

// State defines the local persistent state of the caasoperator, excluding relation
// state.
type State struct {
	...
	// that the caasoperator should return to that hook's Pending state after the
...
// StateFile holds the disk state for a caasoperator.
