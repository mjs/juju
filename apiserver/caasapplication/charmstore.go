...
// TODO - this code should be deduped with the application version.
...
func AddCharmWithAuthorization(st *state.CAASState, args params.AddCharmWithAuthorization) error {
...
func StoreCharmArchive(st *state.CAASState, archive CharmArchive) error {
...
func ResolveCharms(st *state.CAASState, args params.ResolveCharms) (params.ResolveCharmResults, error) {
